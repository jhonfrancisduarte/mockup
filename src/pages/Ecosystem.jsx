  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] pt-20 space-y-8">
      ...
      <section className="container mx-auto px-4">
        <div className="bg-white/5 border border-gray-800 h-[260px] flex items-center justify-center rounded-lg">
      ...
      <section className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((f) => (
            <div
              key={f.id}
              className="rounded-xl border border-gray-800 bg-white/3 p-6 flex flex-col gap-4"
            >
              ...
              <div className="flex-1 space-y-3 mt-2">
                <div className="h-12 bg-white/5 rounded-md border border-gray-800 flex items-center justify-center text-gray-400">
                  {f.title}
                </div>
      ...
      <section className="container mx-auto px-4 text-white">
        ...
        <div className="bg-white/4 border border-gray-800 rounded-lg p-8">
